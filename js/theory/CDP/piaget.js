...
{ id:"criticismMcq", icon:"👩‍🏫", label:"Criticism-mcq" },

{ id:"revision", icon:"👩‍🏫", label:"Rivision" },

{ id:"piaget", icon:"📝", label:"Piaget MCQ", type:"mcq" }
...
<div class="diagram-box" data-diagram="piaget">
Loading diagram...
</div>
...
criticismMcq: criticismMcqTheory(),
revision: rivisionTheory()
};
